...
## [0.13.0](https://github.com/Alexey-Ayupov/vpin/compare/v0.12.0...v0.13.0) - 2024-04-24

### Added
- improve json color fields, add gamedata enums ([#66](https://github.com/Alexey-Ayupov/vpin/pull/66))

### Other
- Update rust.yml
- pin to macOS-13
- example for programmatic table creation ([#65](https://github.com/Alexey-Ayupov/vpin/pull/65))
